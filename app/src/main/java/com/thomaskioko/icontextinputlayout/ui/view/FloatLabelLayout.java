package com.thomaskioko.icontextinputlayout.ui.view;
...
import com.thomaskioko.icontextinputlayout.R;
...
public class FloatLabelLayout extends LinearLayout {
    ...
    public FloatLabelLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        mLabel.setTextColor(context.getResources().getColor(R.color.white));
    ...
    private void setEditText(EditText editText) {
        ...
        mEditText.setTextColor(mContext.getResources().getColor(R.color.white));
        mEditText.setHintTextColor(mContext.getResources().getColor(R.color.white));
